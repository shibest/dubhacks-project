...
export default function GuiltyPleasureAnim() {
  ...
  useEffect(() => {
    ...
    const timer4 = setTimeout(() => navigate("/games/guiltypleasure/chat"), 4000);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-pink-800 to-red-700 flex items-center justify-center relative overflow-hidden">
      ...
      {/* Floating eyes and musical notes */}
      <div className="absolute inset-0">
        {[...Array(12)].map((_, i) => (
          <div
            key={`decor-${i}`}
          ...
          >
            {i % 4 === 0 ? <Eye size={24} className="text-pink-400" /> :
             i % 4 === 1 ? <EyeOff size={24} className="text-purple-400" /> :
             i % 4 === 2 ? <Sparkles size={24} className="text-red-400" /> :
      ...
      <div className="text-center z-10">
        ...
        <div className={`transition-all duration-1000 ${animationStep >= 2 ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          ...
          <div className="flex justify-center items-center gap-4 mb-8">
            <Eye size={40} className="text-pink-400 animate-ping" />
            <span className="text-2xl md:text-3xl font-bold text-red-200">SECRET TUNES</span>
            <EyeOff size={40} className="text-purple-400 animate-ping" />
          </div>
        </div>
        ...
        <div className={`transition-all duration-1000 ${animationStep >= 3 ? 'scale-100 opacity-100' : 'scale-75 opacity-0'}`}>
          <p className="text-xl md:text-2xl text-pink-200 mb-8 font-semibold">
            🤫 Share your most embarrassing music secrets! 🤫
          </p>
          ...
          <div className="flex justify-center items-center gap-2">
            ...
            <span className="text-white font-bold ml-4">Loading guilty pleasures...</span>
          </div>
        </div>
      </div>
      ...
      <div className="absolute top-16 left-8 animate-bounce" style={{ animationDelay: '1s' }}>
        <div className="bg-white rounded-2xl p-3 shadow-lg relative">
          <div className="text-sm font-bold text-gray-800">Don't tell anyone! 🤫</div>
      ...
      <div className="absolute top-28 right-8 animate-bounce" style={{ animationDelay: '1.5s' }}>
        <div className="bg-white rounded-2xl p-3 shadow-lg relative">
          <div className="text-sm font-bold text-gray-800">My secret jam! 🎵</div>
      ...
      <div className="absolute bottom-16 left-16 animate-bounce" style={{ animationDelay: '2s' }}>
        <div className="bg-white rounded-2xl p-3 shadow-lg relative">
          <div className="text-sm font-bold text-gray-800">Shhh... it's our secret! 😏</div>
          <div className="absolute -bottom-2 left-4 w-0 h-0 border-l-4 border-r-4 border-t-4 border-l-transparent border-r-transparent border-t-white"></div>
        </div>
      </div>
    </div>
